...
useEffect(() =>{
  ...
  <div className="modal-dialog modal-dialog-centered">
    <div className="modal-content">
      ...
      {/* heading */}
        <h5 className="modal-title" id="exampleModalToggleLabel">Name</h5>
        {/* close button */}
...
<div className="modal fade" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabIndex="-1">
  ...
  <input type="email" className="form-control" id="exampleFormControlInput1"  value={userDetails.name} readOnly onChange={() =>{}}/>
</div>
{/* email address */}
      <div className="mb-3">
